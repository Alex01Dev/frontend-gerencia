<template>
    <div class="modal" v-if="isVisible">
      <div class="modal-content">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="form-group">
            <label for="totalClientes">Total de Clientes Atendidos:</label>
            <input type="number" id="totalClientes" v-model="sucursal.totalClientes" required />
          </div>
          <div class="form-group">
            <label for="promedioClientes">Promedio de Clientes por Día:</label>
            <input type="number" id="promedioClientes" v-model="sucursal.promedioClientes" required />
          </div>
          <div class="form-group">
            <label for="capacidadMaxima">Capacidad Máxima:</label>
            <input type="number" id="capacidadMaxima" v-model="sucursal.capacidadMaxima" required />
          </div>
          <div class="form-group">
            <label for="totalEmpleados">Total de Empleados:</label>
            <input type="number" id="totalEmpleados" v-model="sucursal.totalEmpleados" required />
          </div>
          <div class="form-group">
  ...
  .modal-content {
    ...
    width: 400px;
    max-width: 90%;
    max-height: 80%; /* Limita la altura máxima del contenido del modal */
